...
cloud = new_tile(
    ...
    light2=(ord(" "), (23, 44, 120), (203, 210, 214)),
...
cloud_wall = new_tile(
    walkable=False,
    transparent=True,
    dark=(ord(" "), (100, 100, 100), (7, 35, 82)),
    light=(ord(" "), (10, 92, 14), (21, 88, 176)),
    dark1=(ord(" "), (100, 100, 100), (7, 35, 82)),
    light1=(ord(" "), (23, 44, 120), (21, 88, 176)),
    dark2=(ord(" "), (100, 100, 100), (7, 35, 82)),
    light2=(ord(" "), (23, 23, 120), (3, 69, 156)),
    dark3=(ord(" "), (100, 100, 100), (7, 35, 82)),
    light3=(ord(" "), (42, 23, 120), (19, 79, 158)),
    dark4=(ord(" "), (100, 100, 100), (7, 35, 82)),
