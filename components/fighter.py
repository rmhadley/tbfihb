...
class Fighter(BaseComponent):
    ...
    def __init__(self, hp: int, mp: int, base_defense: int, min_damage: int, max_damage, strength: int, intelligence: int, dexterity: int, constitution: int, difficulty: int, avoidance: int):
        self._max_hp = hp
        self._max_mp = mp
